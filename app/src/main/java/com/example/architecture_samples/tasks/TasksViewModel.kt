package com.example.architecture_samples.tasks

import androidx.annotation.DrawableRes
import androidx.annotation.StringRes
import androidx.lifecycle.*
import com.example.architecture_samples.Event
import com.example.architecture_samples.R
...
class TasksViewModel(
    ...
    val noTaskIconRes: LiveData<Int> = _noTasksLabel

    private val _noTaskIconRes = MutableLiveData<Int>()
    val noTasksIconRes: LiveData<Int> = _noTaskIconRes

    private val _tasksAddViewVisible = MutableLiveData<Boolean>()
    val taskAddViewVisible: LiveData<Boolean> = _tasksAddViewVisible
    ...
    private fun setFilter(
        ...
        @StringRes noTasksLabelLabelString: Int,
        @DrawableRes noTaskIconDrawable: Int,
        tasksAddVisible: Boolean
    ) {
        _currentFilteringLabel.value = filteringLabelString
        _noTasksLabel.value = noTasksLabelLabelString
